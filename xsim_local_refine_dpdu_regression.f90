program xsim_local_refine_dpdu_regression
! simulate regression changepoints, estimate them by DPDU.regression, and refine them locally
...
real(kind=dp), allocatable :: beta_mat(:, :), beta_seg(:, :)
...
deallocate(partition, cpt_init, cpt_refined, beta_mat, beta_seg)
...
end program xsim_local_refine_dpdu_regression
