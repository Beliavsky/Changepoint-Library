"""
Write simulated input data for deterministic roerich RuLSIF comparisons.
"""
...
from xroerich_rulsif import simulate_roerich_rulsif_signal
...
def main() -> None:
    ...
    with open(data_file, "w", encoding="utf-8") as fh:
        fh.write("# piecewise-Gaussian data for deterministic roerich RuLSIF comparison\n")
