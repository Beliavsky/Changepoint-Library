program xsim_roerich_classifier_cv
! simulate a univariate series and score a deterministic roerich classifier-CV detector
...
end program xsim_roerich_classifier_cv
