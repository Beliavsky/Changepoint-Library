program xsim_local_refine_univar
! simulate a univariate mean-change series, estimate changepoints by WBS, then locally refine them
...
deallocate(y, alpha, beta, s_nodes, dval_nodes, level_nodes, parent_nodes, parent_idx, cpt_hat, dval_hat, cpt_refined)
...
end program xsim_local_refine_univar
