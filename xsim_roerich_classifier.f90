program xsim_roerich_classifier
! simulate a univariate series and score a deterministic roerich classifier-style detector
...
end program xsim_roerich_classifier
