"""
Read a binary series from a text file and detect changepoints with changepoint.Bocpd.
"""
...
def main() -> None:
    ...
    data_file = sys.argv[1] if len(sys.argv) > 1 else "xbocpd_beta_bernoulli_data.txt"
