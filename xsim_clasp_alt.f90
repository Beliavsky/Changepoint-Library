program xsim_clasp_alt
! simulate a second univariate Gaussian series and segment it with fixed-K ClaSP binary segmentation
...
integer, parameter :: seed = 118 ! RNG seed used for the simulated series
...
integer, parameter :: true_cps(nreg) = [0, 120, 240, 360, 480] ! regime start indices in 0-based changepoint notation
