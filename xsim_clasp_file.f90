program xsim_clasp_file
! read a univariate series from a text file and segment it with a fixed-K ClaSP binary segmentation
...
call get_data_file_arg("xclasp_data.txt", data_file)
