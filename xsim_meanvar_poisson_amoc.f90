program xsim_meanvar_poisson_amoc
! simulate a univariate Poisson series and estimate one changepoint by AMOC
...
real(kind=dp), dimension(2) :: rates
...
rates = [5.0_dp, 12.0_dp]
call simulate_piecewise_poisson_1d(n, regime_starts, rates, xi)
x = real(xi, dp)
...
end program xsim_meanvar_poisson_amoc
