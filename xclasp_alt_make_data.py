"""
Write a second simulated input series for claspy/BinaryClaSPSegmentation comparisons.
"""
...
def main() -> None:
    data_file = sys.argv[1] if len(sys.argv) > 1 else "xclasp_alt_data.txt"
    ...
    with open(data_file, "w", encoding="utf-8") as fh:
        fh.write("# alternate piecewise-Gaussian data for BinaryClaSPSegmentation\n")
