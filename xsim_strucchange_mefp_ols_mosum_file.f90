program xsim_strucchange_mefp_ols_mosum_file
use kind_mod, only: dp, long_int
use compare_io_mod, only: read_matrix_file, get_data_file_arg
use strucchange_pkg_mod, only: solve_mefp_ols_mosum_1d
...
call get_data_file_arg("xstrucchange_mefp_ols_mosum_data.txt", data_file)
...
history_n = 50
h = 0.25_dp
critval = 1.341824510076280_dp

call solve_mefp_ols_mosum_1d(y(1:history_n), x(1:history_n, :), y, x, h, critval, process, boundary, breakpoint)
...
end program xsim_strucchange_mefp_ols_mosum_file
