program xsim_wbs_univar_file
! read a univariate series and WBS intervals from text files and estimate changepoints by WBS
...
end program xsim_wbs_univar_file
