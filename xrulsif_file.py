"""
Read a data file and score it with a deterministic Gaussian-kernel RuLSIF detector.
"""
...
def main() -> None:
    ...
    data_path = Path(sys.argv[1]) if len(sys.argv) > 1 else Path("xrulsif_data.txt")
