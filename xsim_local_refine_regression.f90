program xsim_local_refine_regression
! simulate regression changepoints, estimate them by DP.regression, and refine them locally
...
deallocate(partition, cpt_init, cpt_refined)
...
end program xsim_local_refine_regression
