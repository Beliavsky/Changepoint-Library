program xsim_ecp_cp3o_delta_file
use kind_mod, only: dp, long_int
use compare_io_mod, only: read_matrix_file, get_data_file_arg
use ecp_pkg_mod, only: solve_e_cp3o_delta_2d
use util_mod, only: print_wall_time
implicit none

integer, parameter :: kmax = 3, delta = 9
...
call get_data_file_arg("xecp_cp3o_delta_data.txt", data_file)
call read_matrix_file(data_file, x)

call solve_e_cp3o_delta_2d(x, kmax, delta, alpha, number, estimates, gofm, cploc, cploc_lens)
...
end program xsim_ecp_cp3o_delta_file
