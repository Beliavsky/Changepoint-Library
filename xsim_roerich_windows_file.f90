program xsim_roerich_windows_file
! read a univariate series from a text file and score the raw roerich SlidingWindows energy detector
...
call get_data_file_arg("xroerich_windows_data.txt", data_file)
...
end program xsim_roerich_windows_file
