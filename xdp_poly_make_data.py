#!/usr/bin/env python
"""Write data for changepoints::DP.poly comparisons."""
...
def main() -> None:
    data_file = Path(sys.argv[1]) if len(sys.argv) > 1 else Path("xdp_poly_data.txt")
    ...
    with data_file.open("w", encoding="utf-8") as fh:
        fh.write("# y for changepoints::DP.poly\n")
        fh.write(f"# n = {n}\n")
        fh.write(f"# r = {r}\n")
